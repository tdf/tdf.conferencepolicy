...
setup(name='tdf.conferencepolicy',
      version=version,
      description="The policy product for the LibreOffice conference site",
      ...
      keywords='Plone Add-On LibreOffice Conference Policy',
